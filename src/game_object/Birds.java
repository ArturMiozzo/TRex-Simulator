...
public class Birds extends Enemy {
	...
	private Rectangle getHitbox(Bird bird) {
		...
		return new Rectangle((int) bird.x + HITBOX_WINGS_UP[0],
				...
				bird.birdFly.getSprite().getHeight() < WINGS_DOWN_HEIGHT
	...
	public void draw(Graphics g) {
		for (Iterator<Bird> i = birds.iterator(); i.hasNext();) {
			...
			g.drawImage(bird.birdFly.getSprite(), (int) bird.x,
					bird.birdFly.getSprite().getHeight() < 68 ? bird.y + HITBOX_MODELS_DIFF_IN_Y : bird.y, null);
		}
	}
